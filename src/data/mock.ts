...
export const testimonials: Testimonial[] = [
  { id: 'test1', name: 'Rahul Sharma', text: 'FixBro provided excellent plumbing service. Quick and efficient!', rating: 5, avatarUrl: '/default-image.png' },
  { id: 'test2', name: 'Priya Singh', text: 'My AC is working like new after their servicing. Highly recommend.', rating: 4, avatarUrl: '/default-image.png' },
