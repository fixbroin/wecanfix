...
export async function generateMetadata(
  ...
  const title = cityData.seo_title || replacePlaceholders(seoSettings.homepageMetaTitle, placeholderData) || `${cityData.name} Home Services${defaultSuffix}`;
  const description = cityData.seo_description || replacePlaceholders(seoSettings.homepageMetaDescription, placeholderData) || `Find top home services in ${cityData.name}. ${seoSettings.defaultMetaDescription}`;
  const keywordsStr = cityData.seo_keywords || replacePlaceholders(seoSettings.homepageMetaKeywords, placeholderData) || seoSettings.defaultMetaKeywords;
