    ...
    try {
      if (fileToUpload) {
        if (originalDbUrl && isFirebaseStorageUrl(originalDbUrl)) {
          try { await deleteObject(storageRef(storage, originalDbUrl)); } 
        ...
        <TabsContent value="content">
          <Card>
            <CardHeader>
                ...
                <CardDescription>Select a page to edit its title and content. Use simple text or basic HTML for now. Rich text editor can be added later.</CardDescription>
            </CardHeader>
            <CardContent className="space-y-4">
                    ...
                    <form onSubmit={contentPageForm.handleSubmit(handleSaveContentPage)} className="space-y-4">
                        ...
                        <FormField control={contentPageForm.control} name="content" render={({ field }) => (
                            <FormItem>
                                ...
                                <FormControl><Textarea placeholder="Enter page content here... You can use basic HTML tags." {...field} rows={15} /></FormControl>
                                <FormDescription>
                                  This is a plain text area. For rich content, consider integrating a Markdown or HTML editor.
