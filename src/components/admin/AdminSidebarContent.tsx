...
const navItems = [
  ...
  { href: '/admin/visitor-info', label: 'Visitor Info', icon: Globe2 }, // New Link
...
export default function AdminSidebarContent() {
  ...
  const uniqueTopLevelAdminPages = [
    ...
    '/admin/visitor-info', // Added to unique pages
  ];
