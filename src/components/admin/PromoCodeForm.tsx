...
interface PromoCodeFormProps {
  ...
  allPromoCodes: FirestorePromoCode[]; // For client-side uniqueness check
}
...
export default function PromoCodeForm({
  ...
  return (
    <Form {...form}>
      {/* Form takes full height IF its parent (DialogContent) allows it to expand and handles overflow */}
      <form onSubmit={form.handleSubmit(handleSubmit)} className="flex flex-col"> {/* Removed h-full */}
        {/* This div contains the actual form fields and will scroll if parent (DialogContent) allows */}
        <div className="p-6 space-y-5 flex-grow"> {/* Removed overflow-y-auto and flex-grow */}
            <FormField
        ...
        {/* Button footer - sticky to the bottom of the form's viewport, which is now DialogContent */}
