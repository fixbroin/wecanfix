...
import { ArrowLeft, Home as HomeIconLucide, ShoppingCart as ShoppingCartIcon, PackageSearch, Loader2 } from 'lucide-react'; 
...
import Image from 'next/image'; // Added NextImage import
                ...
                {subCategoriesWithServices.map(subCat => {
                  return (
                    <Button
                      ...
                      className="flex items-center gap-2 px-3 py-1.5 h-auto md:px-4 md:py-2 md:h-10 text-xs md:text-sm"
                    >
                      {subCat.imageUrl ? (
                        <div className="w-4 h-4 md:w-5 md:h-5 relative rounded-sm overflow-hidden mr-1 md:mr-1.5">
                        ...
                        <div className="w-4 h-4 md:w-5 md:h-5 relative mr-1 md:mr-1.5">
